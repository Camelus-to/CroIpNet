...
def process_dynamic_connectivity_files(input_dir, dynamic_matrix_dir, output_dir, df):
    ...
    signals_path_yuan = r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ADHD_200\ROISignals_FunImgARglobalCWF"
    ...
    for filename in os.listdir(dynamic_matrix_dir):
        if filename.endswith('.mat'):
            ...
            signals_path = os.path.join(signals_path_yuan, 'ROISignals_' + filename)
            signals = loadmat(signals_path)['ROISignals'][:123, 228:428].T  # The format of the signal should be region*signal length
    ...
    output_file = os.path.join(output_dir, 'connectivity_data_adhd_cc200_shan0.npy')
...
if __name__ == "__main__":
    ...
    static_matrix_dir = r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ADHD_200\cc200\fc_"
    dynamic_matrix_dir = r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ADHD_200\cc200\fc_"
    ...
    # Read CSV file
    df = pd.read_csv(
        r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ADHD_200\ADHD200_Phenotypic_shan0.csv",
    )
