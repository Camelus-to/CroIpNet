...
def process_dynamic_connectivity_files(input_dir, dynamic_matrix_dir, output_dir, df):
    ...
    for filename in os.listdir(dynamic_matrix_dir):
        if filename.endswith('.mat'):
            ...
            signals = loadmat(signals_path)['ROISignals'][:145, 116:212].T  # The format of the signal should be region*signal length
    ...
    output_file = os.path.join(output_dir, 'connectivity_data_abide_Harvard.npy')
...
if __name__ == "__main__":
    ...
    static_matrix_dir = r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ABIDE_I\Harvard\fc"
    dynamic_matrix_dir = r"E:\Technolgy_learning\Learning_code\New_Stage\shujuji\ABIDE_I\Harvard\fc"
